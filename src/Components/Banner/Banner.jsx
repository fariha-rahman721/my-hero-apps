    ...
    return (
        <div className='w-11/12 lg:w-6/12 mx-auto flex flex-col justify-center items-center p-10'>
            ...
            <div className='flex gap-3'>
                <button className='btn '><img className='w-7 h-7 bg-none' src="/g-playstore.png" alt="" />
               Google Play</button>
            <button className='btn '><img className='w-5 h-5 bg-none' src="/appstore.jpeg" alt="" />App Store</button>
            </div>
