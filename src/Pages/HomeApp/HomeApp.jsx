...
const HomeApp = ({data}) => {
    ...
    return (
        ...
        <div className='w-11/12 mx-auto flex justify-center items-center m-4'>
            <Link to='/apps'>
        <button className='btn p-3 bg-gradient-to-r from-purple-600 to-purple-500 text-white font-bold hover:from-pink-600 hover:to-pink-400 mb-5 '>Show all</button>
        </Link>
        </div>
        </div>
    );
